// index.js — AvaTrade demo + MT4 kreiranje (robust + screenshots u logu)
// DEBUG_SCREENSHOTS=1 -> pravi PNG-ove i ispisuje "SNAP: <naziv>"
// Rute: /create-demo, /create-mt4
...
app.post("/create-demo", async (req, res) => {
  ...
  try {
    ...
    // ako se pojavi "Being Created" – zabeleži
